...
![](https://cdn.jsdelivr.net/gh/hyperter96/tech-blog/docs/assets/images/api-machinery-schema.png)
...
当向这个路径发出请求时，通常你想交换数据，要么在创建或更新资源的请求中，要么在获取或列出资源的响应中。这种交换数据的格式被称为`Kind`（或`GroupVersionKind`），与资源有关。
